/*
 * Debug and diagnostics helpers for the dashboard card.
 *
 * The diagnostics panel records configuration, backend, layout, and runtime events so support/debugging
 * can inspect what happened without changing user-facing behavior.
 */
