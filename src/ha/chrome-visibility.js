/*
 * Home Assistant chrome visibility controls.
 *
 * These methods hide or restore the HA header/sidebar, compute safe gutters, and keep page-level chrome
 * in sync with dashboard options and viewport changes.
 */
