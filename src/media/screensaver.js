/*
 * Screensaver overlay behavior and preset application.
 *
 * This module watches user activity, renders the idle overlay, applies screensaver presets/styles, and
 * keeps clock/entity data fresh while the screensaver is visible.
 */

import { getScreenSaverGlobalStyles, getScreenSaverModernCss, getScreenSaverShadowStyles } from '../styles/screensaver-styles.js';
