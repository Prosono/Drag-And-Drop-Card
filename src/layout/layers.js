/*
 * Layer model and layer bar rendering.
 *
 * Layers let users group cards, toggle visibility, and organize complex dashboards without changing the
 * underlying saved card entries.
 */
