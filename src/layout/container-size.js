/*
 * Dashboard container sizing modes.
 *
 * It applies preset, fixed, and automatic canvas dimensions and exposes the CSS variables other layout
 * modules rely on for stable rendering.
 */
