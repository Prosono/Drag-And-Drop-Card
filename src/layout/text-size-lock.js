/*
 * Text resize lock helpers for embedded cards.
 *
 * These methods protect text-heavy child cards from unwanted font scaling while dashboard zoom and card
 * resize operations are running.
 */
