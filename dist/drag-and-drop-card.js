...
`+t.slice(s+1):u+=t.slice(o),u.slice(1)}function Bs(t){for(var h="",e=0,r,o=0;o<t.length;e>=65536?o+=2:o++)e=Ci(t,o),r=bt[e],!r&&zi(e)?(h+=t[o],e>=65536&&(h+=t[o+1])):h+=r||Os(e);return h}function Ns(t,h,e){var r="",o=t.tag,c,s,d;for(c=0,s=e.length;c<s;c+=1)d=e[c],t.replacer&&(d=t.replacer.call(e,String(c),d)),(jt(t,h,d,!1,!1)||typeof d=="undefined"&&jt(t,h,null,!1,!1))&&(r!==""&&(r+=","+(t.condenseFlow?"":" ")),r+=t.dump);t.tag=o,t.dump="["+r+"]"}function ir(t,h,e,r){var o="",c=t.tag,s,d,u;for(s=0,d=e.length;s<d;s+=1)u=e[s],t.replacer&&(u=t.replacer.call(e,String(s),u)),(jt(t,h+1,u,!0,!0,!1,!0)||typeof u=="undefined"&&jt(t,h+1,null,!0,!0,!1,!0))&&((!r||o!=="")&&(o+=yn(t,h)),t.dump&&Ti===t.dump.charCodeAt(0)?o+="-":o+="- ",o+=t.dump);t.tag=c,t.dump=o||"[]"}function qs(t,h,e){var r="",o=t.tag,c=Object.keys(e),s,d,u,g,m;for(s=0,d=c.length;s<d;s+=1)m="",r!==""&&(m+=", "),t.condenseFlow&&(m+='"'),u=c[s],g=e[u],t.replacer&&(g=t.replacer.call(e,u,g)),jt(t,h,u,!1,!1)&&(t.dump.length>1024&&(m+="? "),m+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),jt(t,h,g,!1,!1)&&(m+=t.dump,r+=m));t.tag=o,t.dump="{"+r+"}"}function Hs(t,h,e,r){var o="",c=t.tag,s=Object.keys(e),d,u,g,m,b,y;if(t.sortKeys===!0)s.sort();else if(typeof t.sortKeys=="function")s.sort(t.sortKeys);else if(t.sortKeys)throw new kt("sortKeys must be a boolean or a function");for(d=0,u=s.length;d<u;d+=1)y="",(!r||o!=="")&&(y+=yn(t,h)),g=s[d],m=e[g],t.replacer&&(m=t.replacer.call(e,g,m)),jt(t,h+1,g,!0,!0,!0)&&(b=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,b&&(t.dump&&Ti===t.dump.charCodeAt(0)?y+="?":y+="? "),y+=t.dump,b&&(y+=yn(t,h)),jt(t,h+1,m,!0,b)&&(t.dump&&Ti===t.dump.charCodeAt(0)?y+=":":y+=": ",y+=t.dump,o+=y));t.tag=c,t.dump=o||"{}"}function nr(t,h,e){var r,o,c,s,d,u;for(o=e?t.explicitTypes:t.implicitTypes,c=0,s=o.length;c<s;c+=1)if(d=o[c],(d.instanceOf||d.predicate)&&(!d.instanceOf||typeof h=="object"&&h instanceof d.instanceOf)&&(!d.predicate||d.predicate(h))){if(e?d.multi&&d.representName?t.tag=d.representName(h):t.tag=d.tag:t.tag="?",d.represent){if(u=t.styleMap[d.tag]||d.defaultStyle,Ir.call(d.represent)==="[object Function]")r=d.represent(h,u);else if(Dr.call(d.represent,u))r=d.represent[u](h,u);else throw new kt("!<"+d.tag+'> tag resolver accepts not "'+u+'" style');t.dump=r}return!0}return!1}function jt(t,h,e,r,o,c,s){t.tag=null,t.dump=e,nr(t,e,!1)||nr(t,e,!0);var d=Ir.call(t.dump),u=r,g;r&&(r=t.flowLevel<0||t.flowLevel>h);var m=d==="[object Object]"||d==="[object Array]",b,y;if(m&&(b=t.duplicates.indexOf(e),y=b!==-1),(t.tag!==null&&t.tag!=="?"||y||t.indent!==2&&h>0)&&(o=!1),y&&t.usedDuplicates[b])t.dump="*ref_"+b;else{if(m&&y&&!t.usedDuplicates[b]&&(t.usedDuplicates[b]=!0),d==="[object Object]")r&&Object.keys(t.dump).length!==0?(Hs(t,h,t.dump,o),y&&(t.dump="&ref_"+b+t.dump)):(qs(t,h,t.dump),y&&(t.dump="&ref_"+b+" "+t.dump));else if(d==="[object Array]")r&&t.dump.length!==0?(t.noArrayIndent&&!s&&h>0?ir(t,h-1,t.dump,o):ir(t,h,t.dump,o),y&&(t.dump="&ref_"+b+t.dump)):(Ns(t,h,t.dump),y&&(t.dump="&ref_"+b+" "+t.dump));else if(d==="[object String]")t.tag!=="?"&&Rs(t,t.dump,h,c,u);else{if(d==="[object Undefined]")return!1;if(t.skipInvalid)return!1;throw new kt("unacceptable kind of an object to dump "+d)}t.tag!==null&&t.tag!=="?"&&(g=encodeURI(t.tag[0]==="!"?t.tag.slice(1):t.tag).replace(/!/g,"%21"),t.tag[0]==="!"?g="!"+g:g.slice(0,18)==="tag:yaml.org,2002:"?g="!!"+g.slice(18):g="!<"+g+">",t.dump=g+" "+t.dump)}return!0}function js(t,h){var e=[],r=[],o,c;for(bn(t,e,r),o=0,c=r.length;o<c;o+=1)h.duplicates.push(e[r[o]]);h.usedDuplicates=new Array(c)}function bn(t,h,e){var r,o,c;if(t!==null&&typeof t=="object")if(o=h.indexOf(t),o!==-1)e.indexOf(o)===-1&&e.push(o);else if(h.push(t),Array.isArray(t))for(o=0,c=t.length;o<c;o+=1)bn(t[o],h,e);else for(r=Object.keys(t),o=0,c=r.length;o<c;o+=1)bn(t[r[o]],h,e)}function Ys(t,h){h=h||{};var e=new Ls(h);e.noRefs||js(t,e);var r=t;return e.replacer&&(r=e.replacer.call({"":r},"",r)),jt(e,0,r,!0,!0)?e.dump+`
